...
trainPaths=($(select_files $trainFolder 5))
...
testPaths=($(select_files $testFolder 5))
testPathsString=$(printf "%s " "${testPaths[@]}")

# echo "Train files: $trainPathsString"
# echo "Test files: $testPathsString"

hash=$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 8 | head -n 1)
echo "Output Hash: $hash"

# trainFolder="/lustre_scratch/shaerdan/data_folder/train_v2/train/" 
# trainPaths=()
...
# testFolder="/lustre_scratch/shaerdan/data_folder/test_v2/test/" 
# testPaths=()
