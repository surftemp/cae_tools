...
def objective(trial):
    ...
    params = {
        'nr_epochs': trial.suggest_int('nr_epochs', 600, 600, step=100),
        ...
        'lambda_pearson': trial.suggest_loguniform('lambda_pearson', 1e-5, 1e-2),
    ...
    input_variables = ["land_cover", "albedo_monthly_climatology_means", "elevation", "era5_skt", "sin_doy", "cos_doy", "slope_magnitude", "slope_direction", "era5_u10", "era5_v10", "era5_ssrd"]
