...
#SBATCH --job-name=pB_standard_no_aug
#SBATCH --output=/home/users/shaerdan/cae_tools_pB/logs/pB_no_aug_%j.out
#SBATCH --error=/home/users/shaerdan/cae_tools_pB/logs/pB_no_aug_%j.err
